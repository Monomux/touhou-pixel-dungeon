...
public class TenshiBossSprite extends MobSprite {
	...
	public void link(Char ch) {
		...
		if (ch instanceof TenshiBoss && ((TenshiBoss) ch).isSupercharged()){
