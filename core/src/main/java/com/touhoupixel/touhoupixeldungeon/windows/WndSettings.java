...
public class WndSettings extends WndTabbed {
		...
		protected void createChildren() {
			...
			if (DeviceCompat.isAndroid()) {
				btnOrientation = new RedButton(PixelScene.landscape() ?
					...
					@Override
					protected void onClick() {
						TPDSettings.landscape(!PixelScene.landscape());
					}
				};
				add(btnOrientation);
			}
	...
	private static class UITab extends Component {
		...
		protected void createChildren() {
			...
			if (TPDSettings.toolbarMode().equals(Toolbar.Mode.SPLIT.name())) btnSplit.textColor(TITLE_COLOR);
			add(btnSplit);
			...
			if (TPDSettings.toolbarMode().equals(Toolbar.Mode.GROUP.name())) btnGrouped.textColor(TITLE_COLOR);
			add(btnGrouped);
			...
			if (TPDSettings.toolbarMode().equals(Toolbar.Mode.CENTER.name())) btnCentered.textColor(TITLE_COLOR);
			add(btnCentered);
