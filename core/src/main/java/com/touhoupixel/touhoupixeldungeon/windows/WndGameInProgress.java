...
import com.touhoupixel.touhoupixeldungeon.scenes.StartScene;
	...
	public WndGameInProgress(final int slot){
		...
		Button debug = new Button(){
			...
			protected boolean onLongClick() {
				try {
					...
					TouhouPixelDungeon.scene().addToFront(new WndMessage("_Debug Info:_\n\n" +
		...
		RedButton cont = new RedButton(Messages.get(this, "continue")){
			...
			protected void onClick() {
				...
				TouhouPixelDungeon.switchScene(InterlevelScene.class);
			}
		};
		...
		RedButton erase = new RedButton( Messages.get(this, "erase")){
			...
			protected void onClick() {
				...
				TouhouPixelDungeon.scene().add(new WndOptions(Icons.get(Icons.WARNING),
