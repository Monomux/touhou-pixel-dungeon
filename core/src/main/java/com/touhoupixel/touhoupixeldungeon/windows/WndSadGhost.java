...
import com.touhoupixel.touhoupixeldungeon.sprites.FetidRatSprite;
import com.touhoupixel.touhoupixeldungeon.sprites.GnollTricksterSprite;
import com.touhoupixel.touhoupixeldungeon.sprites.GreatCrabSprite;
		...
		public RewardButton( Item item ){
			...
			slot = new ItemSlot( item ){
				...
				protected void onClick() {
					TouhouPixelDungeon.scene().addToFront(new RewardWindow(item));
				}
			};
			add(slot);
		}
