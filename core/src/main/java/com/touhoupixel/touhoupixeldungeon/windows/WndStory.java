...
public class WndStory extends Window {
	...
	public static final int ID_FOREST		= 4;
	public static final int ID_MORIYA		= 5;
	public static final int ID_SPIRIT		= 6;
	public static final int ID_LUNAR		= 7;
	public static final int ID_SKY		    = 8;
	...
	static {
		...
		CHAPTERS.put( ID_MORIYA, "moriya" );
		CHAPTERS.put( ID_SPIRIT, "spirit" );
		CHAPTERS.put( ID_LUNAR, "lunar" );
		CHAPTERS.put( ID_SKY, "sky" );
