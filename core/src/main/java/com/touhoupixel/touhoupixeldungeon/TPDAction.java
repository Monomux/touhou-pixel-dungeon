...
public class TPDAction extends GameAction {
	...
	public static final GameAction SEARCH      = new TPDAction("search");
	...
	static {
		...
		defaultBindings.put( Input.Keys.S,           TPDAction.SEARCH );
		defaultBindings.put( Input.Keys.Z,           TPDAction.REST );

		defaultBindings.put( Input.Keys.I,           TPDAction.INVENTORY );
		defaultBindings.put( Input.Keys.Q,           TPDAction.QUICKSLOT_1 );
		defaultBindings.put( Input.Keys.W,           TPDAction.QUICKSLOT_2 );
		defaultBindings.put( Input.Keys.E,           TPDAction.QUICKSLOT_3 );
		defaultBindings.put( Input.Keys.R,           TPDAction.QUICKSLOT_4 );

		defaultBindings.put( Input.Keys.A,           TPDAction.TAG_ATTACK );
		defaultBindings.put( Input.Keys.TAB,         TPDAction.TAG_DANGER );
		defaultBindings.put( Input.Keys.D,           TPDAction.TAG_ACTION );
		defaultBindings.put( Input.Keys.ENTER,       TPDAction.TAG_LOOT );
		defaultBindings.put( Input.Keys.T,           TPDAction.TAG_RESUME );
