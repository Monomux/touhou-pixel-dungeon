...
public class v0_8_X_Changes {
	...
	public static void add_v0_8_2_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton(new ChangeButton(Icons.get(Icons.PREFS), Messages.get(ChangesScene.class, "misc"),
				...
				"_-_ Alice intelligence no longer triggers from allies, and no longer affects magically slept enemies.\n" +
		...
		changes.addButton(new ChangeButton(new Image(Assets.Sprites.YAMAME, 144, 0, 16, 16), Messages.get(ChangesScene.class, "bugfixes"),
				...
				"_-_ Visual errors with Cirno's charge up particles\n" +
				...
				"_-_ Various minor errors with the Suika fight\n" +
		...
		changes.addButton( new ChangeButton(new Image( Assets.Sprites.YAMAME, 144, 0, 16, 16), Messages.get(ChangesScene.class, "bugfixes"),
				...
				"_-_ Suika cleansing doomed debuff between first and second phase\n" +
	...
	public static void add_v0_8_0_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new Image(new TojikoSprite()), "Misc Enemies",
		...
		Image i = new Image(new TenshiBossSprite());
		i.scale.set(PixelScene.align(0.74f));
		changes.addButton( new ChangeButton(i, Messages.get(TenshiBoss.class, "name"),
		...
		changes.addButton( new ChangeButton(new Image(new YuyukoBossSprite()), Messages.get(YuyukoBoss.class, "name"),
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.ARMOR_PC98REIMU), "Weapon and Armor Changes",
		...
		changes.addButton( new ChangeButton(Icons.get(Icons.PREFS), Messages.get(ChangesScene.class, "misc"),
				...
				"\n" +
				"_-_ Thrown potions of purity now cleanse Suika's smoke bomb and fire wave effects.\n" +
				"_-_ Wand of blast wave and force cube AOEs no longer trigger Suika's traps.\n" +
				"\n" +
		...
		changes.addButton( new ChangeButton(new Image( Assets.Sprites.YAMAME, 144, 0, 16, 16), Messages.get(ChangesScene.class, "bugfixes"),
				...
				"_-_ Various bugs in the new Suika fight\n" +
		...
		changes.addButton( new ChangeButton(new Image(new RemiliaSprite()), "Necromancers",
				"To better balance overall prison difficulty, I've strengthened necromancers slightly:\n" +
				"_-_ Remilia evasion increased by ~18%"));
		...
		changes.addButton( new ChangeButton(new Image(new YuugiSprite()), "Enemy Nerfs",
