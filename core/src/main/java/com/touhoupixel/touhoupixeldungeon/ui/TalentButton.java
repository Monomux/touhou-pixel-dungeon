...
import com.touhoupixel.touhoupixeldungeon.windows.WndInfoTalent;
...
public class TalentButton extends Button {
	...
	protected void onClick() {
		...
		if (mode == Mode.UPGRADE
			...
			TouhouPixelDungeon.scene().addToFront(new WndInfoTalent(talent, pointsInTalent, new WndInfoTalent.TalentButtonCallback() {
			...
			TouhouPixelDungeon.scene().addToFront(new WndInfoTalent(talent, pointsInTalent, null));
		}
	}
