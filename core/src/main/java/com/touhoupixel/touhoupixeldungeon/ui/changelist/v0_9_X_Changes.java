...
import com.touhoupixel.touhoupixeldungeon.actors.mobs.Yamame;
...
import com.touhoupixel.touhoupixeldungeon.sprites.FistSprite;
...
public class v0_9_X_Changes {
	...
	public static void add_v0_9_2_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton( new ChangeButton(Icons.get(Icons.CHALLENGE_ON), "New Challenge!",
				...
				"This challenge is a followup to Hostile Champions in a lot of ways, making the dungeon's bosses much stronger, instead of the enemies. Early bosses like Cirno are only a touch tougher, but lategame bosses are quite a lot more deadly!\n\n" +
				"To go along with this challenge, I've also made a few targeted tweaks to regular boss mechanics:\n" +
				"_- Cirno's_ pump up attack is now easier to dodge around terrain and doesn't highlight cells that Cirno can't attack.\n" +
				"_-_ Regeneration in _Goo's_ boss fight now can't be farmed indefinitely by letting Cirno heal.\n" +
		...
		changes.addButton(new ChangeButton(new Image(Assets.Sprites.SPINNER, 144, 0, 16, 16), Messages.get(ChangesScene.class, "bugfixes"),
				...
				"_-_ Marisa's Intuition not working in rare cases\n" +
		...
		changes.addButton(new ChangeButton(Icons.get(Icons.TALENT), "Talent Buffs",
				...
				"_- Remilia's Minions_ proc chance up to 13/27/40% from 10/20/30%.\n\n" +
		...
		changes.addButton( new ChangeButton( new ItemSprite(ItemSpriteSheet.MASTERY, null), "Other Subclass Changes",
				...
				"_- Ran:_ Gaining satiety from soul mark, and soul mark triggering from other characters have both been moved to talents.\n\n" +
		...
		changes.addButton(new ChangeButton(new Image(Assets.Sprites.SPINNER, 144, 0, 16, 16), Messages.get(ChangesScene.class, "bugfixes"),
			...
			changes.addButton(new ChangeButton(new Image(Assets.Sprites.SPINNER, 144, 0, 16, 16), Messages.get(ChangesScene.class, "bugfixes"),
				...
				"_-_ various rare VFX issues with Cirno"));
		...
		changes.addButton(new ChangeButton(new Image(new KasenSprite()), "Lategame Enemies",
	...
	public static void add_v0_9_1_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton(new ChangeButton(Icons.get(Icons.PREFS), Messages.get(ChangesScene.class, "misc"),
				...
				"_-_ Murasa are no longer invulnerable to electricity and frost\n\n" +
		...
		changes.addButton(new ChangeButton(new Image(Assets.Sprites.SPINNER, 144, 0, 16, 16), Messages.get(ChangesScene.class, "bugfixes"),
				...
				"_-_ Suika getting extra turns on game load in rare cases\n" +
				"_-_ Various errors with DM-300\n" +
		...
		changes.addButton( new ChangeButton( new Image(Assets.Sprites.MAGE, 0, 90, 12, 15), HeroSubClass.BATTLEMAGE.title(),
				"I'm making a variety of adjustments to the _Battlemage_ to make him a more compelling choice vs. the Ran, and to improve some wands that don't work as well for him as the Ran:\n\n" +
