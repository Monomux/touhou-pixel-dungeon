...
import com.touhoupixel.touhoupixeldungeon.effects.BadgeBanner;
...
public class v0_7_X_Changes {
	...
	public static void add_v0_7_3_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(Icons.get(Icons.PREFS), Messages.get(ChangesScene.class, "misc"),
				...
				"_-_ Suika now throws his shurikens one at a time, just like other ranged enemies. The speed of the shurikens has been increased to compensate, so that the player doesn't need to keep waiting while Suika's attacks are in flight.\n\n" +
	...
	public static void add_v0_7_2_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new Image(Assets.Sprites.YAMAME, 144, 0, 16, 16), Messages.get(ChangesScene.class, "bugfixes"),
				...
				"_-_ Suika spawning on top of other characters\n" +
	...
	public static void add_v0_7_1_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new Image(Assets.Sprites.YAMAME, 144, 0, 16, 16), Messages.get(ChangesScene.class, "bugfixes"),
				...
				"_-_ various freeze bugs caused by Suika"));
		...
		changes.addButton( new ChangeButton( new Image(Assets.Sprites.ROGUE, 0, 15, 12, 15), "Hero Buffs",
				...
				"_-_ Ran's soul mark base chance increased to 15% from 10%, scaling reduced to compensate.\n\n" +
				"_-_ Ran's soul mark hunger restoration increased by 100%, health restoration increased by 33%."));
	...
	public static void add_v0_7_0_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.ARTIFACT_BEACON, null), "Boss reward changes",
				...
				"_-_ Cirno and DM-300 now drop unique alchemy ingredients instead.\n\n" +
