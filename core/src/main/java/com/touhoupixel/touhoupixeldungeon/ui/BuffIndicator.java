...
public class BuffIndicator extends Component {
	...
	public static final int SUPEROOZE   = 58;
	public static final int SILENCE     = 59;
	public static final int HISOU       = 60;
	public static final int HIGHSTRESS  = 61;
	public static final int UNDERWATERCURSE   = 62;
	public static final int ANTIHEAL    = 63;
	public static final int DOUBLEEVASION    = 64;
	public static final int POTIONPRESERVE    = 65;
	public static final int MOVEDETECT    = 66;
	public static final int ANTISNEAKATTACK    = 67;
	public static final int INCOMPETENCE    = 68;
	public static final int ARISASTARRANK1    = 69;
	public static final int ARISASTARRANK2    = 70;
	public static final int ARISASTARRANK3    = 71;
	public static final int YUUKARAGE         = 72;
	public static final int NOWISHING         = 73;
	public static final int ONEDAMAGE         = 74;
	public static final int ONEDEFDAMAGE         = 75;
	public static final int HATRESIST         = 76;
