...
import com.touhoupixel.touhoupixeldungeon.levels.painters.SkyPainter;
...
public class DekaiSkyLevel extends RegularLevel {
	...
	public String tilesTex() {
		return Assets.Environment.TILES_SKY;
	}
	
	@Override
	public String waterTex() {
		return Assets.Environment.WATER_SKY;
	}
	...
	public String tileName( int tile ) {
		switch (tile) {
			case Terrain.WATER:
				return Messages.get(DekaiSkyLevel.class, "water_name");
			default:
	...
	public String tileDesc(int tile) {
		switch (tile) {
			case Terrain.EMPTY_DECO:
				return Messages.get(DekaiSkyLevel.class, "empty_deco_desc");
			case Terrain.BOOKSHELF:
				return Messages.get(DekaiSkyLevel.class, "bookshelf_desc");
			default:
