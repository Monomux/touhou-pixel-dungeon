...
public class MoriyaLevel extends RegularLevel {
	...
	protected Class<?>[] trapClasses() {
		return new Class[]{
				...
				RockfallTrap.class, FlashingTrap.class, WeakeningTrap.class, AlarmTrap.class, ExConfusionTrap.class,
	...
	public String tileName( int tile ) {
		switch (tile) {
			case Terrain.WATER:
				return Messages.get(MoriyaLevel.class, "water_name");
			default:
	...
	public String tileDesc(int tile) {
		switch (tile) {
			case Terrain.EMPTY_DECO:
				return Messages.get(MoriyaLevel.class, "empty_deco_desc");
			case Terrain.BOOKSHELF:
				return Messages.get(MoriyaLevel.class, "bookshelf_desc");
			default:
