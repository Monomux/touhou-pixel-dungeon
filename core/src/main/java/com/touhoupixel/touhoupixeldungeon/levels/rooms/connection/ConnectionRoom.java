...
public abstract class ConnectionRoom extends Room {
	...
	static {
		chances[1] = new float[]{15, 4,    0, 2,       3, 2};
		chances[5] = chances[4] = chances[3] = chances[2] = chances[1];

		chances[6] = new float[]{15, 4,    0, 2,       3, 2};
		chances[9] = chances[8] = chances[7] = chances[6];
		chances[10] =  new float[]{20, 0,    0, 0,       0, 0};

		chances[11] = new float[]{15, 4,    3, 2,       3, 2};
		chances[15] = chances[14] = chances[13] = chances[12] = chances[11];

		chances[16] = new float[]{15, 4,    0, 2,       3, 2};
		chances[20] = chances[19] = chances[18] = chances[17] = chances[16];

		chances[21] = new float[]{15, 4,    3, 2,       3, 2};
