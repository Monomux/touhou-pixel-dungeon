...
import com.touhoupixel.touhoupixeldungeon.levels.rooms.standard.EmptyRoom;
...
public class SentryRoom extends SpecialRoom {
	...
	public static class Sentry extends NPC {
		...
		public void onZapComplete(){
			Dungeon.hero.damage(Random.NormalIntRange(2+Dungeon.depth/2, 4+Dungeon.depth), new Junko.DeathGaze());
