...
public class DekaiMoriyaLevel extends RegularLevel {
	...
	public String tileName( int tile ) {
		switch (tile) {
			case Terrain.WATER:
				return Messages.get(DekaiMoriyaLevel.class, "water_name");
			default:
	...
	public String tileDesc(int tile) {
		switch (tile) {
			case Terrain.EMPTY_DECO:
				return Messages.get(DekaiMoriyaLevel.class, "empty_deco_desc");
			case Terrain.BOOKSHELF:
				return Messages.get(DekaiMoriyaLevel.class, "bookshelf_desc");
			default:
