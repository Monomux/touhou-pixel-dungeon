...
import com.touhoupixel.touhoupixeldungeon.levels.painters.LunarPainter;
...
public class LunarLevel extends RegularLevel {
	...
	public String tilesTex() {
		return Assets.Environment.TILES_LUNAR;
	}
	
	@Override
	public String waterTex() {
		return Assets.Environment.WATER_LUNAR;
	}
	...
	public String tileName( int tile ) {
		switch (tile) {
			case Terrain.WATER:
				return Messages.get(LunarLevel.class, "water_name");
			default:
	...
	public String tileDesc(int tile) {
		switch (tile) {
			case Terrain.EMPTY_DECO:
				return Messages.get(LunarLevel.class, "empty_deco_desc");
			case Terrain.BOOKSHELF:
				return Messages.get(LunarLevel.class, "bookshelf_desc");
			default:
