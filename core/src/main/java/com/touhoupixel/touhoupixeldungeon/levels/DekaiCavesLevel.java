...
public class DekaiCavesLevel extends RegularLevel {
	...
	public String tileName( int tile ) {
		switch (tile) {
			case Terrain.GRASS:
				return Messages.get(DekaiCavesLevel.class, "grass_name");
			case Terrain.HIGH_GRASS:
				return Messages.get(DekaiCavesLevel.class, "high_grass_name");
			case Terrain.WATER:
				return Messages.get(DekaiCavesLevel.class, "water_name");
			default:
	...
	public String tileDesc( int tile ) {
		switch (tile) {
			case Terrain.ENTRANCE:
				return Messages.get(DekaiCavesLevel.class, "entrance_desc");
			case Terrain.EXIT:
				return Messages.get(DekaiCavesLevel.class, "exit_desc");
			case Terrain.HIGH_GRASS:
				return Messages.get(DekaiCavesLevel.class, "high_grass_desc");
			case Terrain.WALL_DECO:
				return Messages.get(DekaiCavesLevel.class, "wall_deco_desc");
			case Terrain.BOOKSHELF:
				return Messages.get(DekaiCavesLevel.class, "bookshelf_desc");
			default:
