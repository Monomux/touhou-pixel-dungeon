...
import com.touhoupixel.touhoupixeldungeon.levels.painters.CityPainter;
import com.touhoupixel.touhoupixeldungeon.levels.painters.Painter;
import com.touhoupixel.touhoupixeldungeon.levels.painters.SpiritPainter;
...
public class SpiritLevel extends RegularLevel {
	...
	public String tilesTex() {
		return Assets.Environment.TILES_SPIRIT;
	}
	
	@Override
	public String waterTex() {
		return Assets.Environment.WATER_SPIRIT;
	}
	...
	protected Class<?>[] trapClasses() {
		return new Class[]{
				...
				RockfallTrap.class, FlashingTrap.class, WeakeningTrap.class, AlarmTrap.class, DegradeTrap.class, AntiHealTrap.class, ExConfusionTrap.class,
	...
	public String tileName( int tile ) {
		switch (tile) {
			case Terrain.WATER:
				return Messages.get(SpiritLevel.class, "water_name");
			default:
	...
	public String tileDesc(int tile) {
		switch (tile) {
			case Terrain.EMPTY_DECO:
				return Messages.get(SpiritLevel.class, "empty_deco_desc");
			case Terrain.BOOKSHELF:
				return Messages.get(SpiritLevel.class, "bookshelf_desc");
			default:
