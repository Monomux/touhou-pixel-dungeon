...
import com.touhoupixel.touhoupixeldungeon.effects.EmoIcon;
...
import com.touhoupixel.touhoupixeldungeon.sprites.DiscardedItemSprite;
...
import com.touhoupixel.touhoupixeldungeon.tiles.DungeonTerrainTilemap;
import com.touhoupixel.touhoupixeldungeon.tiles.DungeonTileSheet;
import com.touhoupixel.touhoupixeldungeon.tiles.DungeonTilemap;
import com.touhoupixel.touhoupixeldungeon.tiles.DungeonWallsTilemap;
import com.touhoupixel.touhoupixeldungeon.tiles.FogOfWar;
import com.touhoupixel.touhoupixeldungeon.tiles.GridTileMap;
import com.touhoupixel.touhoupixeldungeon.tiles.RaisedTerrainTilemap;
import com.touhoupixel.touhoupixeldungeon.tiles.TerrainFeaturesTilemap;
import com.touhoupixel.touhoupixeldungeon.tiles.WallBlockingTilemap;
...
import com.touhoupixel.touhoupixeldungeon.ui.CharHealthIndicator;
import com.touhoupixel.touhoupixeldungeon.ui.GameLog;
import com.touhoupixel.touhoupixeldungeon.ui.Icons;
import com.touhoupixel.touhoupixeldungeon.ui.InventoryPane;
import com.touhoupixel.touhoupixeldungeon.ui.LootIndicator;
import com.touhoupixel.touhoupixeldungeon.ui.MenuPane;
import com.touhoupixel.touhoupixeldungeon.ui.QuickSlotButton;
import com.touhoupixel.touhoupixeldungeon.ui.ResumeIndicator;
import com.touhoupixel.touhoupixeldungeon.ui.RightClickMenu;
import com.touhoupixel.touhoupixeldungeon.ui.StatusPane;
import com.touhoupixel.touhoupixeldungeon.ui.StyledButton;
import com.touhoupixel.touhoupixeldungeon.ui.Tag;
import com.touhoupixel.touhoupixeldungeon.ui.TargetHealthIndicator;
import com.touhoupixel.touhoupixeldungeon.ui.Toast;
import com.touhoupixel.touhoupixeldungeon.ui.Toolbar;
...
import com.touhoupixel.touhoupixeldungeon.windows.WndInfoCell;
import com.touhoupixel.touhoupixeldungeon.windows.WndInfoItem;
import com.touhoupixel.touhoupixeldungeon.windows.WndInfoMob;
import com.touhoupixel.touhoupixeldungeon.windows.WndInfoPlant;
import com.touhoupixel.touhoupixeldungeon.windows.WndInfoTrap;
...
public class GameScene extends PixelScene {
	...
	public void create() {
		...
		if (Dungeon.depth <= 5) {
			Music.INSTANCE.playTracks(
					new String[]{Assets.Music.SEWERS_1, Assets.Music.SEWERS_1, Assets.Music.SEWERS_1},
					new float[]{1, 1, 0.5f},
					false);
		} else if (Dungeon.depth <= 10) {
			Music.INSTANCE.playTracks(
					new String[]{Assets.Music.PRISON_1, Assets.Music.PRISON_1, Assets.Music.PRISON_1},
					new float[]{1, 1, 0.5f},
					false);
		} else if (Dungeon.depth <= 15) {
			Music.INSTANCE.playTracks(
					new String[]{Assets.Music.CAVES_1, Assets.Music.CAVES_1, Assets.Music.CAVES_1},
					new float[]{1, 1, 0.5f},
					false);
		} else if (Dungeon.depth <= 20) {
			Music.INSTANCE.playTracks(
					new String[]{Assets.Music.CITY_1, Assets.Music.CITY_1, Assets.Music.CITY_1},
					new float[]{1, 1, 0.5f},
					false);
		} else if (Dungeon.depth <= 25) {
			Music.INSTANCE.playTracks(
					new String[]{Assets.Music.FOREST_1, Assets.Music.FOREST_1, Assets.Music.FOREST_1},
					new float[]{1, 1, 0.5f},
					false);
		} else if (Dungeon.depth <= 30) {
			Music.INSTANCE.playTracks(
					new String[]{Assets.Music.MORIYA_1, Assets.Music.MORIYA_1, Assets.Music.MORIYA_1},
					new float[]{1, 1, 0.5f},
					false);
		} else if (Dungeon.depth <= 35) {
			Music.INSTANCE.playTracks(
					new String[]{Assets.Music.SPIRIT_1, Assets.Music.SPIRIT_1, Assets.Music.SPIRIT_1},
					new float[]{1, 1, 0.5f},
					false);
		} else if (Dungeon.depth <= 40) {
			Music.INSTANCE.playTracks(
					new String[]{Assets.Music.LUNAR_1, Assets.Music.LUNAR_1, Assets.Music.LUNAR_1},
					new float[]{1, 1, 0.5f},
					false);
		} else if (Dungeon.depth <= 45) {
			Music.INSTANCE.playTracks(
					new String[]{Assets.Music.SKY_1, Assets.Music.SKY_1, Assets.Music.SKY_1},
					new float[]{1, 1, 0.5f},
					false);
		} else if (Dungeon.depth <= 50) {
			Music.INSTANCE.playTracks(
					new String[]{Assets.Music.HALLS_1, Assets.Music.HALLS_1, Assets.Music.HALLS_1},
					new float[]{1, 1, 0.5f},
					false);
		} else if (Dungeon.depth <= 55) {
			Music.INSTANCE.playTracks(
					new String[]{Assets.Music.DEKAISEWERS_1, Assets.Music.DEKAISEWERS_1, Assets.Music.DEKAISEWERS_1},
					new float[]{1, 1, 0.5f},
					false);
		} else if (Dungeon.depth <= 60) {
			Music.INSTANCE.playTracks(
					new String[]{Assets.Music.DEKAIPRISON_1, Assets.Music.DEKAIPRISON_1, Assets.Music.DEKAIPRISON_1},
					new float[]{1, 1, 0.5f},
					false);
		} else if (Dungeon.depth <= 65) {
			Music.INSTANCE.playTracks(
					new String[]{Assets.Music.DEKAICAVES_1, Assets.Music.DEKAICAVES_1, Assets.Music.DEKAICAVES_1},
					new float[]{1, 1, 0.5f},
					false);
		} else if (Dungeon.depth <= 70) {
			Music.INSTANCE.playTracks(
					new String[]{Assets.Music.DEKAICITY_1, Assets.Music.DEKAICITY_1, Assets.Music.DEKAICITY_1},
					new float[]{1, 1, 0.5f},
					false);
		} else if (Dungeon.depth <= 75) {
			Music.INSTANCE.playTracks(
					new String[]{Assets.Music.DEKAIFOREST_1, Assets.Music.DEKAIFOREST_1, Assets.Music.DEKAIFOREST_1},
					new float[]{1, 1, 0.5f},
					false);
		} else if (Dungeon.depth <= 80) {
			Music.INSTANCE.playTracks(
					new String[]{Assets.Music.DEKAIMORIYA_1, Assets.Music.DEKAIMORIYA_1, Assets.Music.DEKAIMORIYA_1},
					new float[]{1, 1, 0.5f},
					false);
		} else if (Dungeon.depth <= 85) {
			Music.INSTANCE.playTracks(
					new String[]{Assets.Music.DEKAISPIRIT_1, Assets.Music.DEKAISPIRIT_1, Assets.Music.DEKAISPIRIT_1},
					new float[]{1, 1, 0.5f},
					false);
		} else if (Dungeon.depth <= 90) {
			Music.INSTANCE.playTracks(
					new String[]{Assets.Music.DEKAILUNAR_1, Assets.Music.DEKAILUNAR_1, Assets.Music.DEKAILUNAR_1},
					new float[]{1, 1, 0.5f},
					false);
		} else if (Dungeon.depth <= 95) {
			Music.INSTANCE.playTracks(
					new String[]{Assets.Music.DEKAISKY_1, Assets.Music.DEKAISKY_1, Assets.Music.DEKAISKY_1},
					new float[]{1, 1, 0.5f},
					false);
		} else if (Dungeon.depth <= 100) {
			Music.INSTANCE.playTracks(
					new String[]{Assets.Music.DEKAIHALLS_1, Assets.Music.DEKAIHALLS_1, Assets.Music.DEKAIHALLS_1},
					new float[]{1, 1, 0.5f},
					false);
		} else {
			Music.INSTANCE.playTracks(
		...
		TPDSettings.lastClass(Dungeon.hero.heroClass.ordinal());

		super.create();
		Camera.main.zoom( GameMath.gate(minZoom, defaultZoom + TPDSettings.zoom(), maxZoom));
		...
		int uiSize = TPDSettings.interfaceSize();
			...
			case FALL:
				switch (Dungeon.depth) {
					...
					case 21:
						...
						break;
					case 26:
						WndStory.showChapter( WndStory.ID_MORIYA );
						break;
					case 31:
						WndStory.showChapter( WndStory.ID_SPIRIT );
						break;
					case 35:
						WndStory.showChapter( WndStory.ID_LUNAR );
						break;
					case 41:
						WndStory.showChapter( WndStory.ID_SKY );
						break;
					case 46:
			...
			if (Dungeon.depth == Statistics.deepestFloor
				...
				if (spawnersAbove > 0 && Dungeon.depth <= 25) {
					for (Mob m : Dungeon.level.mobs) {
						if (m instanceof ReisenSpawner && ((ReisenSpawner) m).spawnRecorded) {
							spawnersAbove--;
						}
					}
	...
	public static void layoutTags() {
		...
		boolean tagsOnLeft = TPDSettings.flipTags();
		float tagWidth = Tag.SIZE + (tagsOnLeft ? insets.left : insets.right);
		float tagLeft = tagsOnLeft ? 0 : uiCamera.width - tagWidth;

		float y = TPDSettings.interfaceSize() == 0 ? scene.toolbar.top()-2 : scene.status.top()-2;
		if (tagsOnLeft) {
		...
		if (tagsOnLeft && TPDSettings.interfaceSize() > 0){
	...
	public static void examineObject(Object o){
		if (o == Dungeon.hero){
			...
			if (o instanceof Mystia && !Document.ADVENTURERS_GUIDE.isPageRead(Document.GUIDE_SURPRISE_ATKS)){
				GLog.p(Messages.get(Guidebook.class, "hint"));
