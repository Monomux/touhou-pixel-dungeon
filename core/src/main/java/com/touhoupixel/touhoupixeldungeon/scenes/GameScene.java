...
import com.touhoupixel.touhoupixeldungeon.effects.CircleArc;
...
import com.touhoupixel.touhoupixeldungeon.ui.BusyIndicator;
...
public class GameScene extends PixelScene {
	...
	public static void layoutTags() {
		...
		float tagLeft = TPDSettings.flipTags() ? 0 : uiCamera.width - scene.attack.width();

		if (TPDSettings.flipTags()) {
