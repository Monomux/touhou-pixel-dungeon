...
import com.touhoupixel.touhoupixeldungeon.items.LostBackpack;
...
public class InterlevelScene extends PixelScene {
	...
	public void create() {
		...
		else if (lastRegion == 5)    loadingAsset = Assets.Interfaces.LOADING_FOREST;
		else if (lastRegion == 6)    loadingAsset = Assets.Interfaces.LOADING_MORIYA;
		else if (lastRegion == 7)    loadingAsset = Assets.Interfaces.LOADING_SPIRIT;
		else if (lastRegion == 8)    loadingAsset = Assets.Interfaces.LOADING_LUNAR;
		else if (lastRegion == 9)    loadingAsset = Assets.Interfaces.LOADING_SKY;
		else if (lastRegion == 10)   loadingAsset = Assets.Interfaces.LOADING_HALLS;
		else if (lastRegion == 11)   loadingAsset = Assets.Interfaces.LOADING_SEWERS;
		else if (lastRegion == 12)   loadingAsset = Assets.Interfaces.LOADING_PRISON;
		else if (lastRegion == 13)   loadingAsset = Assets.Interfaces.LOADING_CAVES;
		else if (lastRegion == 14)   loadingAsset = Assets.Interfaces.LOADING_CITY;
		else if (lastRegion == 15)   loadingAsset = Assets.Interfaces.LOADING_FOREST;
		else if (lastRegion == 16)   loadingAsset = Assets.Interfaces.LOADING_MORIYA;
		else if (lastRegion == 17)   loadingAsset = Assets.Interfaces.LOADING_SPIRIT;
		else if (lastRegion == 18)   loadingAsset = Assets.Interfaces.LOADING_LUNAR;
		else if (lastRegion == 19)   loadingAsset = Assets.Interfaces.LOADING_SKY;
		else if (lastRegion == 20)   loadingAsset = Assets.Interfaces.LOADING_HALLS;
	...
	public void update() {
		...
		case STATIC:
			if (error != null) {
				...
				TouhouPixelDungeon.reportException(
