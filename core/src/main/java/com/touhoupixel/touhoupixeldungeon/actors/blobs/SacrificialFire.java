...
import com.touhoupixel.touhoupixeldungeon.effects.particles.SacrificialParticle;
import com.touhoupixel.touhoupixeldungeon.levels.rooms.special.SacrificeRoom;
	...
	public static void sacrifice( Char ch ) {
		...
		if (fire != null && fire.cur[ch.pos] > 0) {
			...
			if (ch instanceof Mob) {
				...
				if (ch instanceof Narumi || ch instanceof Mimic){
					exp = 1 + Dungeon.depth;
