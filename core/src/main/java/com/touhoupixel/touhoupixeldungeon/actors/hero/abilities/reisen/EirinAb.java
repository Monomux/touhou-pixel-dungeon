...
public class EirinAb extends ArmorAbility {
	...
	@Override
	public int icon() {
		return HeroIcon.EIRINAB;
	}

	@Override
	public Talent[] talents() {
		return new Talent[]{Talent.FOOD_HEAL, Talent.POTION_HEAL, Talent.GOLD_HEAL, Talent.HEROIC_ENERGY};
	}
