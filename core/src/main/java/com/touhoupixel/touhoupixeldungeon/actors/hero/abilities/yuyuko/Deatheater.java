...
public class Deatheater extends ArmorAbility {
	...
	@Override
	public int icon() {
		return HeroIcon.DEATHEATER;
	}

	@Override
	public Talent[] talents() {
		return new Talent[]{Talent.YOKAI_MEAL, Talent.FLOAT_MEAL, Talent.GOD_MEAL, Talent.HEROIC_ENERGY};
	}
}
