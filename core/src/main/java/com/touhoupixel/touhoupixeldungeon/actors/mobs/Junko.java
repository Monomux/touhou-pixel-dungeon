...
public class Junko extends Mob {
	...
	public int damageRoll() {
		if (Dungeon.depth > 50) {
			return Random.NormalIntRange(51+Statistics.ankhsUsed*40, 58+Statistics.ankhsUsed*40);
		} else return Random.NormalIntRange(31+Statistics.ankhsUsed*30, 36+Statistics.ankhsUsed*30);
	}
