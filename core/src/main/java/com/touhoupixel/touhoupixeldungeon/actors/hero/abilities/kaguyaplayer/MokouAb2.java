...
public class MokouAb2 extends ArmorAbility {
	...
	@Override
	public int icon() {
		return HeroIcon.MOKOUAB2;
	}

	@Override
	public Talent[] talents() {
		return new Talent[]{Talent.GAIN_ANKH, Talent.GAIN_ANOTHER_HEALWAND, Talent.BURN_IMMUN_AND_GAIN_INVU, Talent.HEROIC_ENERGY};
	}
}
