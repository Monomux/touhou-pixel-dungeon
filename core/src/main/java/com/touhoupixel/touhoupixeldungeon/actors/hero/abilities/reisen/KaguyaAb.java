...
public class KaguyaAb extends ArmorAbility {
	...
	@Override
	public int icon() {
		return HeroIcon.KAGUYAAB;
	}

	@Override
	public Talent[] talents() {
		return new Talent[]{Talent.ANKH_GAIN, Talent.INVU_ATTACK, Talent.TRIPLESPEED_ATTACK, Talent.HEROIC_ENERGY};
	}
