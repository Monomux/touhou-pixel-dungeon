...
public class GreenVentora extends ArmorAbility {
	...
	@Override
	public int icon() {
		return HeroIcon.GREENVENTORA;
	}

	@Override
	public Talent[] talents() {
		return new Talent[]{Talent.BOMB_EXTEND, Talent.AQUA_TRIPLESPEED, Talent.AQUA_INVU, Talent.HEROIC_ENERGY};
	}
}
