...
public class Greenkappa extends ArmorAbility {
	...
	@Override
	public int icon() {
		return HeroIcon.GREENKAPPA;
	}

	@Override
	public Talent[] talents() {
		return new Talent[]{Talent.FIERY_POTION, Talent.HEX_POTION, Talent.SPEED_POTION, Talent.HEROIC_ENERGY};
	}
