...
public class EirinAb2 extends ArmorAbility {
	...
	@Override
	public int icon() {
		return HeroIcon.EIRINAB2;
	}

	@Override
	public Talent[] talents() {
		return new Talent[]{Talent.GAIN_MORE_ALCHEMY_ENERGY, Talent.POTION_PRESERVE_ATTACK, Talent.MAXHP_DAMAGE, Talent.HEROIC_ENERGY};
	}
}
