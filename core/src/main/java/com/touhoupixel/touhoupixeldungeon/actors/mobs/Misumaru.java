...
public class Misumaru extends Mob {
	...
	public int damageRoll() {
		if (Dungeon.depth > 50) {
			return Random.NormalIntRange(Statistics.goldCollected/600, Statistics.goldCollected/400);
		} else return Random.NormalIntRange(Statistics.goldCollected/600, Statistics.goldCollected/500);
	}
