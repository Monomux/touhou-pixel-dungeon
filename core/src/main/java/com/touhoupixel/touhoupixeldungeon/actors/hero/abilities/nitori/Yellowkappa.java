...
public class Yellowkappa extends ArmorAbility {
	...
	@Override
	public int icon() {
		return HeroIcon.YELLOWKAPPA;
	}

	@Override
	public Talent[] talents() {
		return new Talent[]{Talent.SLOW_STRIKE, Talent.LUNATIC_STRIKE, Talent.COMMOTION_STRIKE, Talent.HEROIC_ENERGY};
	}
}
