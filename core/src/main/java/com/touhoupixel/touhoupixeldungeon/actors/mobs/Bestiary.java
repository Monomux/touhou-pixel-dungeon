		...
		switch (depth) {
			...
			case 10:
				if (Statistics.amuletObtained){
					...
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Rumia.class, Patchouli.class, Marisa.class, Remilia.class, Joon.class, Lily.class));
				} else if (!Statistics.altRoute && !Dungeon.isChallenged(Challenges.HECATIA_TIME)){
					return new ArrayList<>(Arrays.asList(
							Rumia.class, Patchouli.class, Marisa.class, Remilia.class, Joon.class, Lily.class));
				} else if (Statistics.altRoute && Dungeon.isChallenged(Challenges.HECATIA_TIME)){
					return new ArrayList<>(Arrays.asList(
	...
	public static void addRareMobs( int depth, ArrayList<Class<?extends Mob>> rotation ){
		...
		switch (depth){
			...
			default:
				return;
			case 4:
				if (Random.Float() < 0.00001f) rotation.add(Koakuma.class);
				return;

			// Prison
			case 9:
				if (Random.Float() < 0.00001f) rotation.add(Tsukasa.class);
				return;
		}
	}
