...
import com.touhoupixel.touhoupixeldungeon.sprites.EirinSprite;
...
public class Eirin extends Mob implements Callback {
	...
	public int damageRoll() {
		if (Dungeon.depth > 50) {
			return Random.NormalIntRange(61, 67);
	...
	private void zap() {
		...
		if (hit( this, enemy, true )) {
			...
			if (enemy == Dungeon.hero && Random.Int( 2 ) == 0) {
				switch (Random.Int(8)) {
					...
					case 1:
						...
						break;
					case 2:
						Buff.affect(enemy, Poison.class).set(10);
						break;
					case 3:
					...
					case 4:
						...
						break;
					case 5:
						new FlashingTrap().set(target).activate();
						break;
					case 6:
						new BurningTrap().set(target).activate();
						break;
					case 7:
			...
			int dmg = Random.NormalIntRange( 24, 28 );
