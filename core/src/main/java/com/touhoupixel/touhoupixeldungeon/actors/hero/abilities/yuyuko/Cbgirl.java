...
public class Cbgirl extends ArmorAbility {
	...
	@Override
	public int icon() {
		return HeroIcon.CBGIRL;
	}

	@Override
	public Talent[] talents() {
		return new Talent[]{Talent.YOMI_POTION, Talent.SUICIDE_BUTTERFLY, Talent.REFLOWERING, Talent.HEROIC_ENERGY};
	}
}
