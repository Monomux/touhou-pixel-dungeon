...
import com.touhoupixel.touhoupixeldungeon.actors.mobs.FetidRat;
import com.touhoupixel.touhoupixeldungeon.actors.mobs.GnollTrickster;
import com.touhoupixel.touhoupixeldungeon.actors.mobs.GreatCrab;
...
import com.touhoupixel.touhoupixeldungeon.windows.WndSadGhost;
	...
	public static class Quest {
		...
		public static void spawn( SewerLevel level ) {
			if (!spawned && Dungeon.depth > 1 && Random.Int( 5 - Dungeon.depth ) == 0) {
				...
				if (itemLevelRoll < 0f){
					itemLevel = 0;
				} else if (itemLevelRoll < 0.5f){
					itemLevel = 1;
				} else if (itemLevelRoll < 1f){
					itemLevel = 2;
				} else {
					itemLevel = 3;
				}
