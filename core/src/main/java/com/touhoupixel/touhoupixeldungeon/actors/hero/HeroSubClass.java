...
public enum HeroSubClass {
	...
	GAPMASTER(HeroIcon.GAPMASTER),
	BORDERMASTER(HeroIcon.BORDERMASTER),

	PURITYGOD(HeroIcon.PURITYGOD),
	PUREGOD(HeroIcon.PUREGOD),

	STARSEEKER(HeroIcon.STARSEEKER),
	LUNARSEEKER(HeroIcon.LUNARSEEKER),

	TURNMASTER(HeroIcon.TURNMASTER),
	GRAVMASTER(HeroIcon.GRAVMASTER),

	SOUCOLLECTOR(HeroIcon.SOUCOLLECTOR),
	MISCCOLLECTOR(HeroIcon.MISCCOLLECTOR);
