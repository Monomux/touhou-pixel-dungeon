...
public class Supermedicine extends ArmorAbility {
	...
	@Override
	public int icon() {
		return HeroIcon.SUPERMEDICINE;
	}

	@Override
	public Talent[] talents() {
		return new Talent[]{Talent.UNIDENTIFY_MEDICINE, Talent.LONG_INVU, Talent.OMNISCIENCE_GAIN, Talent.HEROIC_ENERGY};
	}
}
