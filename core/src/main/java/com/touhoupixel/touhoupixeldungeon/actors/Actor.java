...
public abstract class Actor implements Bundlable {
	...
	private static HashSet<com.touhoupixel.touhoupixeldungeon.actors.Char> chars = new HashSet<>();
	...
	public static void process() {
		...
		do {
			...
			if  (current != null) {
				...
				if (acting instanceof com.touhoupixel.touhoupixeldungeon.actors.Char && ((com.touhoupixel.touhoupixeldungeon.actors.Char) acting).sprite != null) {
					// If it's character's turn to act, but its sprite
					// is moving, wait till the movement is over
					try {
						synchronized (((com.touhoupixel.touhoupixeldungeon.actors.Char)acting).sprite) {
							if (((com.touhoupixel.touhoupixeldungeon.actors.Char)acting).sprite.isMoving) {
								((com.touhoupixel.touhoupixeldungeon.actors.Char) acting).sprite.wait();
							}
						}
	...
	private static synchronized void add( Actor actor, float time ) {
		...
		if (actor instanceof com.touhoupixel.touhoupixeldungeon.actors.Char) {
			com.touhoupixel.touhoupixeldungeon.actors.Char ch = (com.touhoupixel.touhoupixeldungeon.actors.Char)actor;
			chars.add( ch );
	...
	public static synchronized com.touhoupixel.touhoupixeldungeon.actors.Char findChar(int pos ) {
		for (com.touhoupixel.touhoupixeldungeon.actors.Char ch : chars){
			if (ch.pos == pos)
				return ch;
		}
		return null;
	...
	public static synchronized HashSet<com.touhoupixel.touhoupixeldungeon.actors.Char> chars() { return new HashSet<>(chars); }
}