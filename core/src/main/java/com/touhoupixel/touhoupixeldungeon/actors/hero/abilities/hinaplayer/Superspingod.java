...
public class Superspingod extends ArmorAbility {
	...
	@Override
	public int icon() {
		return HeroIcon.SUPERSPINGOD;
	}

	@Override
	public Talent[] talents() {
		return new Talent[]{Talent.SPIN_CHARM, Talent.SPIN_DOOM, Talent.SPIN_PARALYSIS, Talent.HEROIC_ENERGY};
	}
}
