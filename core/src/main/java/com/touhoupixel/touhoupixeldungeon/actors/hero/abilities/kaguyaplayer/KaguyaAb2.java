...
package com.touhoupixel.touhoupixeldungeon.actors.hero.abilities.kaguyaplayer;
...
public class KaguyaAb2 extends ArmorAbility {
	...
	@Override
	public int icon() {
		return HeroIcon.KAGUYAAB2;
	}

	@Override
	public Talent[] talents() {
		return new Talent[]{Talent.GAIN_HEALING_SET_AND_ANTIHEAL_RES, Talent.HEALWAND_LVL, Talent.HEALWAND_NURSE, Talent.HEROIC_ENERGY};
	}
}
