...
public class TPDSettings extends GameSettings {
	...
	public static void fullscreen( boolean value ) {
		...
		TouhouPixelDungeon.updateSystemUI();
	}
	...
	public static void landscape( boolean value ){
		...
		((TouhouPixelDungeon)TouhouPixelDungeon.instance).updateDisplaySize();
	}
