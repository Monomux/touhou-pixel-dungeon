...
public class MurasaDipper extends MeleeWeapon {
	...
	{
		image = ItemSpriteSheet.MURASADIPPER;
	...
	public int max(int lvl) {
		return  Math.round((Statistics.piranhasKilled)*4.7f+4f*(tier+1)) +    //20 base, up from 15
	...
	public int damageRoll(Char owner) {
		if (owner instanceof Hero) {
			...
			if (Dungeon.isChallenged(Challenges.ANTI_FUMO) && Dungeon.hero.belongings.weapon() instanceof MurasaDipper) {
