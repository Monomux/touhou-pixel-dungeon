...
public class FullmoonScythe extends MeleeWeapon {

	{
		image = ItemSpriteSheet.FULLMOONSCYTHE;
	...
	public int damageRoll(Char owner) {
		if (owner instanceof Hero) {
			...
			if (Dungeon.isChallenged(Challenges.ANTI_FUMO) && Dungeon.hero.belongings.weapon() instanceof FullmoonScythe) {
