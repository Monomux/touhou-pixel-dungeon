...
public class DoubleSword extends MeleeWeapon {
	...
	{
		image = ItemSpriteSheet.DOUBLE_SWORD;
	...
	public int damageRoll(Char owner) {
		if (owner instanceof Hero) {
			...
			if (Dungeon.isChallenged(Challenges.ANTI_FUMO) && Dungeon.hero.belongings.weapon() instanceof DoubleSword) {
	...
	private final WndBag.ItemSelector itemSelector = new WndBag.ItemSelector() {
		...
		public boolean itemSelectable(Item item) {
			return item instanceof TurnaboutCloak;
		}
