...
public class SwordofHisou extends MeleeWeapon {

	{
		image = ItemSpriteSheet.SWORDOFHISOU;
		hitSound = Assets.Sounds.HIT_SLASH;
		hitSoundPitch = 0.8f;

		tier = 5;
		DLY = 0.5f; //0.67x speed
		RCH = 2;    //extra reach
		ACC = 4f;
	}
	...
	public int damageRoll(Char owner) {
		if (owner instanceof Hero) {
			...
			if (Dungeon.isChallenged(Challenges.ANTI_FUMO) && Dungeon.hero.belongings.weapon() instanceof SwordofHisou) {
