...
public class YuyukoFoldingFan extends MeleeWeapon {

	{
		image = ItemSpriteSheet.YUYUKOFOLDINGFAN;
	...
	public int damageRoll(Char owner) {
		if (owner instanceof Hero) {
			...
			if (Dungeon.isChallenged(Challenges.ANTI_FUMO) && Dungeon.hero.belongings.weapon() instanceof YuyukoFoldingFan) {
