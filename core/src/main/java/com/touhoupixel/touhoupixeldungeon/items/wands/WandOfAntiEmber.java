...
public class WandOfAntiEmber extends DamageWand {

	{
		image = ItemSpriteSheet.WAND_ANTIEMBER;
	...
	private void affectTarget(Char ch){
		...
		if (Dungeon.level.map[ch.pos] == Terrain.EMBERS){
			Sample.INSTANCE.play(Assets.Sounds.BURNING);

			ch.damage((int)(dmg*5f), this);
		} else {
