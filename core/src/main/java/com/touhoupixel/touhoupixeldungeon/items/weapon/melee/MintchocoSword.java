...
public class MintchocoSword extends MeleeWeapon {

	{
		image = ItemSpriteSheet.MINTCHOCOSWORD;
	...
	public int damageRoll(Char owner) {
		if (owner instanceof Hero) {
			...
			if (Dungeon.hero.belongings.weapon() instanceof MintchocoSword && enemy.properties().contains(Char.Property.YOKAI)) {
