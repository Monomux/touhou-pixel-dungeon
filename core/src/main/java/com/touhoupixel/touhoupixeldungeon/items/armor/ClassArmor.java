	...
	public static ClassArmor upgrade (Hero owner, Armor armor ) {
		...
		switch (owner.heroClass) {
			...
			case HUNTRESS:
				...
				break;
			case REISEN:
				classArmor = new ReisenArmor();
				break;
			case NITORI:
				classArmor = new NitoriArmor();
				break;
			case YUYUKO:
				classArmor = new YuyukoArmor();
				break;
			case MURASA:
				classArmor = new MurasaArmor();
				break;
			case HINAPLAYER:
				classArmor = new HinaplayerArmor();
				break;
			case KAGUYAPLAYER:
				classArmor = new KaguyaplayerArmor();
				break;
		}
