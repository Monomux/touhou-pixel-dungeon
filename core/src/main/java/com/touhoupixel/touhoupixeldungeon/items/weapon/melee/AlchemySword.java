...
public class AlchemySword extends MeleeWeapon {

	{
		image = ItemSpriteSheet.ALCHEMY_SWORD;
	...
	public int damageRoll(Char owner) {
		if (owner instanceof Hero) {
			...
			if (Dungeon.hero.belongings.weapon() instanceof AlchemySword && (Random.Int(10) == 0)) {
				Dungeon.energy += 1;
			}
		}
