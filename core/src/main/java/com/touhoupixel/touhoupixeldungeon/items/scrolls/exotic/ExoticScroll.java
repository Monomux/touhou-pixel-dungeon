...
public abstract class ExoticScroll extends Scroll {
	...
	static{
		...
		regToExo.put(ScrollOfSlowness.class, ScrollOfTorment.class);
		exoToReg.put(ScrollOfTorment.class, ScrollOfSlowness.class);

		regToExo.put(ScrollOfBurning.class, ScrollOfWeakness.class);
		exoToReg.put(ScrollOfWeakness.class, ScrollOfBurning.class);

		regToExo.put(ScrollOfSilence.class, ScrollOfPrismriver.class);
		exoToReg.put(ScrollOfPrismriver.class, ScrollOfSilence.class);

		regToExo.put(ScrollOfRouteChange.class, ScrollOfLimitBreak.class);
		exoToReg.put(ScrollOfLimitBreak.class, ScrollOfRouteChange.class);
	}
