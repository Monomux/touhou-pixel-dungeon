...
public class Iceapple extends Food {

	{
		image = ItemSpriteSheet.ICEAPPLE;
	...
	public static void effect(Hero hero){
		switch (Random.Int( 0 )) {
			case 0:
				...
				Buff.affect( hero, MindVision.class, MindVision.DURATION/5f );
				break;
		}
	}
	public static class Recipe extends com.touhoupixel.touhoupixeldungeon.items.Recipe.SimpleRecipe {
		...
		{
			inputs =  new Class[]{Ice.class, Food.class};
			inQuantity = new int[]{1, 1};

			cost = 4;

			output = Iceapple.class;
			outQuantity = 1;
		}
