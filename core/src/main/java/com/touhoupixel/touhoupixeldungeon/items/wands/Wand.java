...
public abstract class Wand extends Item {
	...
	public Item upgrade() {
		...
		if (this.level()>7 && this instanceof WandOfReverseGravity){
			GLog.w(Messages.get(this, "upgradefail"));
		} else if (this instanceof WandOfDeath){
			GLog.w(Messages.get(this, "upgradefail"));
		} else if (this.level()>7 && this instanceof WandOfHealWounds){
			GLog.w(Messages.get(this, "upgradefail"));
		} else if (this.level()>7 && this instanceof WandOfDestOrb){
			GLog.w(Messages.get(this, "upgradefail"));
		} else if (this instanceof WandOfWishing){
			GLog.w(Messages.get(this, "upgradefail_wishing"));
		} else
