...
public class Halfcake extends Food {

	{
		image = ItemSpriteSheet.HALFCAKE;
	...
	public static void effect(Hero hero){
		switch (Random.Int( 0 )) {
			case 0: case 1: case 2: case 3:
				...
				Buff.affect( hero, Invisibility.class, Invisibility.DURATION/3f );
				break;
		}
	}
	public static class Recipe extends com.touhoupixel.touhoupixeldungeon.items.Recipe.SimpleRecipe {
		...
		{
			inputs =  new Class[]{Half.class, Pancake.class};
			inQuantity = new int[]{1, 1};

			cost = 4;

			output = Halfcake.class;
			outQuantity = 1;
		}
