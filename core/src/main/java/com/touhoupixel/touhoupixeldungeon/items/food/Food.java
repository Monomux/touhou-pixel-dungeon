...
public class Food extends Item {
	...
	protected float eatingTime(){
		if (Dungeon.hero.hasTalent(Talent.IRON_STOMACH)
				...
				|| Dungeon.hero.hasTalent(Talent.EIENTEI_ENHANCE_MEAL)
				|| Dungeon.hero.hasTalent(Talent.KAPPA_ENHANCE_MEAL)
				|| Dungeon.hero.hasTalent(Talent.CURSED_EXTRA_MEAL)
				|| Dungeon.hero.hasTalent(Talent.INVIGORATING_MEAL)) {
			return TIME_TO_EAT - 2;
		} else if (Dungeon.hero.hasTalent(Talent.QUICK_MEAL)){
			return TIME_TO_EAT - 3;
		} else if (Dungeon.hero.hasTalent(Talent.EXHAUSTIVE_FOOD)){
			return TIME_TO_EAT + 2;
		} else {
			return TIME_TO_EAT;
		}
