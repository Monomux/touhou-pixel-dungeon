...
import com.touhoupixel.touhoupixeldungeon.actors.mobs.FlandreBoss;
import com.touhoupixel.touhoupixeldungeon.actors.mobs.Cirno;
import com.touhoupixel.touhoupixeldungeon.actors.mobs.KisumeBoss;
import com.touhoupixel.touhoupixeldungeon.actors.mobs.Suika;
import com.touhoupixel.touhoupixeldungeon.actors.mobs.HecatiaBoss;
...
public class WandOfReverseGravity extends Wand {

	{
		image = ItemSpriteSheet.WAND_REVERSEGRAVITY;
		...
		if (ch != null) {
			if (!ch.flying) {
				if (!ch.properties().contains(Char.Property.BOSS)){
					...
					ch.HP = 1;
					Buff.prolong(ch, Doubleevasion.class, Doubleevasion.DURATION);
				}
			}
		}
	}
	...
	public void onHit(MagesStaff staff, Char attacker, Char defender, int damage) {
			Buff.prolong(attacker, Hisou.class, 5f);
