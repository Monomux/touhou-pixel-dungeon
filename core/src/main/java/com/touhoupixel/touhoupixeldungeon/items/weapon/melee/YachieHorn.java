...
public class YachieHorn extends MeleeWeapon {
	...
	public int max(int lvl) {
		return  8*(tier+1) +    //20 base, down from 25
	...
	public int damageRoll(Char owner) {
		if (owner instanceof Hero) {
			...
			if (Dungeon.hero.belongings.weapon() instanceof YachieHorn) {
				Buff.prolong(owner, ExtremeConfusion.class, ExtremeConfusion.DURATION);
			}
		}
