...
public class YorihimeSword extends MeleeWeapon {

	{
		image = ItemSpriteSheet.YORIHIME_SWORD;
	...
	public int damageRoll(Char owner) {
		if (owner instanceof Hero) {
			...
			if (Dungeon.hero.belongings.weapon() instanceof YorihimeSword) {
				Buff.prolong(enemy, Slow.class, Slow.DURATION / 5f);
			}
			if (Dungeon.isChallenged(Challenges.ANTI_FUMO) && Dungeon.hero.belongings.weapon() instanceof YorihimeSword) {
