...
public class KoishiSword extends MeleeWeapon {

	{
		image = ItemSpriteSheet.KOISHI_SWORD;
	...
	public int damageRoll(Char owner) {
		if (owner instanceof Hero) {
			...
			if (Dungeon.isChallenged(Challenges.ANTI_FUMO) && Dungeon.hero.belongings.weapon() instanceof KoishiSword) {
