...
public class KomachiScythe extends MeleeWeapon {

	{
		image = ItemSpriteSheet.KOMACHISCYTHE;
	...
	public int max(int lvl) {
		return  Math.round(14f*(tier+1)) +    //20 base, up from 15
	...
	public int damageRoll(Char owner) {
		if (owner instanceof Hero) {
			...
			if (Dungeon.isChallenged(Challenges.ANTI_FUMO) && Dungeon.hero.belongings.weapon() instanceof KomachiScythe) {
