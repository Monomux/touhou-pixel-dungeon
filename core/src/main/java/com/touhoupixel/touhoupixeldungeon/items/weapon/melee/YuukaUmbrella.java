...
public class YuukaUmbrella extends MeleeWeapon {
	...
	public int damageRoll(Char owner) {
		if (owner instanceof Hero) {
			...
			if (Dungeon.hero.belongings.weapon() instanceof YuukaUmbrella) {
			...
			if (Dungeon.isChallenged(Challenges.ANTI_FUMO) && Dungeon.hero.belongings.weapon() instanceof YuukaUmbrella) {
